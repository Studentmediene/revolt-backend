...
def populate_digas_id(apps, schema_editor):
    ...
    # Keep track of which digas_ids that are already used, to adhere to uniqueness
    # constraint for model field.
    used_digas_ids = { id for id in Show.objects.values_list('digas_id', flat=True) }
